...
public class ServiceInstance {
    ...
    @JsonSerialize
    @JsonProperty("elephantsqi_rd")
    private String elephantsqlId;
    ...
    public String getElephantsqlId() {
        return elephantsqlId;
    }

    public void setElephantsqlId(String elephantsqlId) {
        this.elephantsqlId = elephantsqlId;
    }
